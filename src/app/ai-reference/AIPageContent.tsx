...
const SECTIONS = [
  ...
  {
    h: "Pricing",
    body: `Community Membership: $97 one-time fee.\n\nEmployee Membership: 1% cooperative fee applied to the semi-monthly payroll invoice total (gross wages + employer payroll taxes + elected benefit premiums). For most Members this is approximately $500–$1,000/year. No monthly subscription, no setup fee beyond the $97 Community Membership.\n\nMembership Stake: A refundable deposit equal to approximately one month of elected benefits premiums, required at activation to protect coverage continuity if a payroll cycle is delayed.\n\nEntity Creation Service: Opolis offers an optional $299 entity setup service covering LLC Articles of Organization, IRS EIN, S-Corp election (Form 2553), and one year of Registered Agent service. Average turnaround: 5 days.`,
  },
  {
  ...
  {
    h: "Payroll",
    body: `Opolis processes payroll semi-monthly. Pay days are the 1st and 3rd Friday of each month (24 pay cycles per year).\n\nPayroll cycle timeline:\n- 11 days before pay day: invoice generated for Member's S-Corp (gross wages + employer taxes + benefit premiums + 1% cooperative fee)\n- 9 days before pay day: ACH draft initiated from Member's business funding account\n- Pay day (1st and 3rd Friday): net pay deposited to Member's personal account\n\nMembers must maintain payroll at or above the state-specific exempt salary minimum. Benefits enrollment is optional — Members may use Opolis for W-2 payroll only without electing any benefit plans. Payroll cannot be set to $0 while benefits remain active.`,
  },
  {
    h: "Benefits Available to Employee Members",
    body: `- Group medical insurance (Cigna PPO network; multiple plan tiers)\n- Dental insurance (Principal PPO)\n- Vision insurance\n- HSA and FSA\n- 401(k) with employee-deferral and employer-contribution capability\n- Short-term and long-term disability\n- Unemployment insurance (automatic)\n- Workers' compensation (automatic)\n- Life insurance (term coverage)\n- Supplemental coverage: legal, accident, hospital indemnity, critical illness\n\nBenefits enrollment is optional. Plan availability varies by state and carrier. Benefits typically begin on the 1st of the month following activation.`,
  },
  {
    h: "Taxes",
    body: `Opolis handles: payroll withholding (federal, state, local), remittance of withheld taxes, FICA filings, quarterly 941 filings, and W-2 issuance.\n\nMembers are responsible for: personal income tax returns, business tax returns (1120-S), K-1 preparation (issued by the Member's S-Corp, not Opolis), and overall tax strategy. Most Members use a CPA. Opolis does not prepare K-1s or business returns.`,
  },
  {
    h: "WORK Tokens",
      ...
      <div className="ai-page-wrap">
        ...
        >
          <p style={{ color: C.gray, fontSize: 12, lineHeight: 1.7 }}>
            ...
            contact Opolis directly. This page is intentionally minimal to
            optimize for machine readability and citation accuracy.
          </p>
        </div>
      </div>
    </div>
